        ...
        {isMain2 ? (
          ...
          >
            <div className="mobile-site-footer__box">
              <div className="mobile-site-footer__main">
                <div className="mobile-site-footer__brand">
                  <p className="mobile-site-footer__company">Embark LLC</p>
                  <a
                    className="mobile-site-footer__email"
                    href="mailto:hi@embark.ai"
                  >
                    hi@embark.ai
                  </a>
                  <p className="mobile-site-footer__address">
                    548 Market Street
                    <br />
