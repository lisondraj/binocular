...
export const FOURTH_SECTION_BY_AUDIENCE = [
  {
    title: "Kitchens",
    subtitle: "Prep, chop & wipe surfaces",
    pricePerHour: "$48",
    rating: 4.9,
    reviewCount: 142,
    hosts: [
    ...
    image: "/images/kitchen.png",
    alt: "Kitchen surfaces for robot touch training",
  },
  {
    title: "Warehouses",
    subtitle: "Pick, pack & pallet routes",
    pricePerHour: "$68",
    rating: 4.8,
    reviewCount: 97,
    hosts: [
    ...
    image: "/images/warehouse-1.png",
    alt: "Warehouse floors for robot touch training",
  },
  {
    title: "Factory floors",
    subtitle: "Assembly & inspection tasks",
    pricePerHour: "$62",
    rating: 4.7,
    reviewCount: 58,
    hosts: [
    ...
    image: "/images/warehouse-1.png",
    alt: "Factory floor environments for robot touch training",
  },
  {
    title: "Retail aisles",
    subtitle: "Shelf stocking & facing",
    pricePerHour: "$44",
    rating: 4.8,
    reviewCount: 73,
    hosts: [{ initials: "DF", gradient: "135deg, #748ffc 0%, #5c7cfa 100%" }],
    image: "/images/kitchen.png",
    alt: "Retail aisles for robot touch training",
  },
  {
    title: "Homes",
    subtitle: "Tidy, fetch & open doors",
    pricePerHour: "$52",
    rating: 4.9,
    reviewCount: 118,
    hosts: [
    ...
    image: "/images/courtyard.png",
    alt: "Home environments for robot touch training",
  },
] as const;
