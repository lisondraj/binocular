...
export const FOURTH_SECTION_BY_AUDIENCE = [
  {
    title: "Elderly",
    subtitle: "Daily living & companionship",
    pricePerHour: "$52",
    rating: 4.9,
    reviewCount: 142,
    hosts: [
    ...
    image: "/images/courtyard.png",
    alt: "Spaces supporting elderly daily living",
  },
  {
    title: "Caregivers",
    subtitle: "Respite & household relief",
    pricePerHour: "$48",
    rating: 4.8,
    reviewCount: 97,
    hosts: [
    ...
    image: "/images/kitchen.png",
    alt: "Spaces supporting caregiver routines",
  },
  {
    title: "Families",
    subtitle: "Kid-safe home routines",
    pricePerHour: "$44",
    rating: 4.7,
    reviewCount: 58,
    hosts: [
    ...
    image: "/images/courtyard.png",
    alt: "Family-friendly spaces for robot assistance",
  },
  {
    title: "Busy parents",
    subtitle: "Meals, tidy & school runs",
    pricePerHour: "$46",
    rating: 4.8,
    reviewCount: 73,
    hosts: [{ initials: "MR", gradient: "135deg, #5c7cfa 0%, #364fc7 100%" }],
    image: "/images/kitchen.png",
    alt: "Spaces supporting busy parent routines",
  },
  {
    title: "Mobility needs",
    subtitle: "Reach, lift & fetch support",
    pricePerHour: "$56",
    rating: 4.9,
    reviewCount: 118,
    hosts: [
    ...
    image: "/images/warehouse-1.png",
    alt: "Accessible spaces for mobility support",
  },
] as const;
